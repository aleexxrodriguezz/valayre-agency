...
(function () {
  ...
  const I18N = {
    es: {
      ...
      'hero.eyebrow':'IA · Sistemas complejos · Web premium',
      'hero.t1':'Ingeniería de software','hero.t2':'con Inteligencia Artificial','hero.t3':'y diseño web impecable.',
      'hero.lead':'Construimos sistemas a medida y webs de altísimo nivel. Diseño impecable, ingeniería seria y entrega en un máximo de 4 días.',
      ...
      'serv.eyebrow':'Lo que hacemos','serv.title':'Dos disciplinas, un estándar.',
      'serv.1.t':'Sistemas complejos con IA','serv.1.d':'Agentes, automatizaciones y herramientas a medida que eliminan trabajo manual y escalan tu operación. Ingeniería seria, no experimentos.',
      'serv.1.a':'Agentes con IA','serv.1.b':'Automatización','serv.1.c':'Integraciones','serv.1.e':'Datos',
      'serv.2.t':'Webs premium a medida','serv.2.d':'Landings y sitios de estética impecable, rápidos y 100% responsive. Diseño personalizado orientado a conversión, sin plantillas. Empezando por el nuestro.',
      'serv.2.a':'Diseño a medida','serv.2.b':'Rendimiento','serv.2.c':'SEO técnico','serv.2.e':'Responsive',
      ...
      'proc.3.t':'Ingeniería','proc.3.d':'Construcción rápida y sólida. Web, sistema o IA con calidad de agencia.',
    ...
    en: {
      ...
      'hero.eyebrow':'AI · Complex systems · Premium web',
      'hero.t1':'Software engineering','hero.t2':'powered by Artificial Intelligence','hero.t3':'and flawless web design.',
      'hero.lead':'We build custom systems and top-tier websites. Flawless design, serious engineering and delivery in 4 days max.',
      ...
      'serv.eyebrow':'What we do','serv.title':'Two disciplines, one standard.',
      'serv.1.t':'Complex AI systems','serv.1.d':'Agents, automations and custom tools that remove manual work and scale your operation. Serious engineering, not experiments.',
      'serv.1.a':'AI agents','serv.1.b':'Automation','serv.1.c':'Integrations','serv.1.e':'Data',
      'serv.2.t':'Premium custom websites','serv.2.d':'Landings and sites with flawless aesthetics, fast and fully responsive. Bespoke, conversion-driven design — no templates. Starting with our own.',
      'serv.2.a':'Bespoke design','serv.2.b':'Performance','serv.2.c':'Technical SEO','serv.2.e':'Responsive',
      ...
      'proc.3.t':'Engineering','proc.3.d':'Fast, solid build. Web, system or AI with agency-grade quality.',
